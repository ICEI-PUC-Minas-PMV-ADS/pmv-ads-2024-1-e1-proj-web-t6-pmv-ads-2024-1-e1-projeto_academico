...
async function startAttendanceModule() {
    ...
    const form = document.querySelector('.grade-page .grade-search-form');
    const wrapper = document.querySelector('.grade-page .lista-wrapper');
    const title = document.querySelector('.grade-page .grade-empty-title');
                ...
                if (query.length) {
                    ...
                    if (!filtered.length) {
                        ...
                        rows.forEach(elemento => {
                            ...
                            buttonAction.textContent = 'Lançar notas';
                        ...
                        items.forEach((elemento) => {
                            ...
                            buttonAction.addEventListener('click', (event) => {
                                ...
                                navigateToRoute(null, `/turmas/notas/${id}`);
                            });
                        });
